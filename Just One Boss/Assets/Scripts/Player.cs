...
public class Player : MonoBehaviour
{
    ...
    public PlayerGridMoveController PlayerGridMoveController { get; private set; }
    ...
    void Awake()
    {
        ...
        PlayerGridMoveController = GetComponent<PlayerGridMoveController>();
    ...
    public void Initialize()
    {
        ...
        PlayerGridMoveController.Initialize(this);
